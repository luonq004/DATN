                ...
                <div className="Your_Cart flex flex-col py-8 gap-6">
                        ...
                        <div className="grid transition-all duration-500 grid-cols-[81px_auto] max-sm:grid-cols-[75px_auto] gap-x-4 border-[#F4F4F4] border-b pb-6">
                            ...
                            <div className="Image_Product">
                                <div className="border border-[#dddcdc] rounded-[6px] p-1">
                                    <img className="w-full h-full" src="../src/assets/products/product-1.svg" alt="img" />
                                </div>
                            </div>
                            {/* information */}
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex items-center gap-4 max-sm:justify-between">
                                    ...
                                    <div className="relative">
                                        <div className="flex items-center gap-3 border rounded-md py-1 px-3 cursor-pointer max-sm:*:text-[14px]" onClick={() => setAttribute(attribute !== 2 ? 2 : 1)}>
                                            <div>
                                                <p>M</p>
                                            </div>
                    ...
                    <div className="Bottom border-t border-[#F4F4F4] pt-6 grid grid-cols-3 gap-6 max-sm:gap-4">
                        <div className='flex gap-4 flex-col'>
                            ...
                            <div className='flex flex-col border border-[#F4F4F4] rounded-[12px] p-4 gap-4'>
                                <div className='Icon flex justify-center items-center w-1 h-1 bg-light-50 p-6 rounded-full'>
                                    <img className='max-w-max' src="../src/assets/icons/transaction-minus.svg" alt="" />
                                </div>
                        ...
                        <div className='flex gap-4 flex-col'>
                            ...
                            <div className='flex flex-col border border-[#F4F4F4] rounded-[12px] p-4 gap-4'>
                                <div className='Icon flex justify-center items-center w-1 h-1 bg-light-50 p-6 rounded-full'>
                                    <img className='max-w-max' src="../src/assets/icons/box-time.svg" alt="" />
                                </div>
                                <p className='text-[18px] max-sm:text-[14px]'>
                        ...
                        <div className='flex gap-4 flex-col'>
                            ...
                            <div className='flex flex-col border border-[#F4F4F4] rounded-[12px] p-4 gap-4'>
                                <div className='Icon flex justify-center items-center w-1 h-1 bg-light-50 p-6 rounded-full'>
                                    <img className='max-w-max' src="../src/assets/icons/truck-time.svg" alt="" />
                                </div>
                                <p className='text-[18px] max-sm:text-[14px]'>
                ...
                <div className='Cart__Right py-8'>
                    <div className='flex flex-col gap-6 border border-[#F4F4F4] rounded-[16px] p-6'>
                        ...
                        <div className='Code-Sale flex items-center justify-between gap-4'>
                            ...
                            <div className='py-3 px-5 rounded-full text-light-400 text-[14px] bg-light-50 whitespace-nowrap'>
                                Apply Coupon
                            </div>
                        </div>
                        ...
                        <div className='flex justify-center items-center'>
                            <div className='bg-[#C8C9CB] flex justify-center items-center w-full py-4 gap-4 rounded-full text-white'>
                                <div>Checkout</div>
                                <div className=''>|</div>
                        ...
                        <div className='Payments flex flex-col gap-4'>
                            <p className='text-[#717378] uppercase text-[14px] tracking-[2px]'>SECURE PAYMENTS PROVIDED BY</p>
                            <div className='flex gap-3'>
                                <div className='border border-[#e2e2e2] py-2 px-3 flex justify-center items-center rounded-[6px]'>
                                    <img src="../src/assets/icons/idk.svg" alt="" />
                                </div>
                                <div className='border border-[#e2e2e2] py-2 px-3 flex justify-center items-center rounded-[6px]'>
                                    <img src="../src/assets/icons/Visa.svg" alt="" />
                                </div>
                                <div className='border border-[#e2e2e2] py-2 px-3 flex justify-center items-center rounded-[6px]'>
                                    <img src="../src/assets/icons/Bitcoin.svg" alt="" />
                                </div>
                                <div className='border border-[#e2e2e2] py-2 px-3 flex justify-center items-center rounded-[6px]'>
                                    <img src="../src/assets/icons/Interac.svg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
