            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between lg:items-center p-5 lg:p-0 mt-5 lg:mt-0 h-full relative z-20 space-y-4 md:space-y-0">
                  ...
                  <div className="text-slate-50 space-y-3 lg:pl-32">
                    ...
                    <div className="flex flex-col font-questrial lg:flex-row text-start lg:items-center gap-5">
                      ...
                      <div className="flex flex-col font-questrial lg:flex-row mr-5 md:mr-0 text-xs gap-3">
              ...
              {index === 2 && (
                <div className="flex flex-col p-5 lg:p-0 mt-5 lg:mt-0 lg:items-center lg:justify-center md:text-center w-full h-full space-y-5 z-20">
                  ...
                  <div className="flex relative md:justify-center flex-col mr-5 md:mr-0 lg:flex-row lg:items-center gap-5 z-20 items-center">
                    <button className="group text-xs relative md:px-16 py-6 bg-white text-gray-800 rounded-full font-semibold overflow-hidden w-fit">
                      <span className="absolute inset-0 flex items-center justify-center transition-all duration-200 ease-in-out transform group-hover:translate-x-full group-hover:opacity-0">
                        TÌM HIỂU THÊM
                      </span>
                      <span className="absolute inset-y-0 left-0 flex items-center justify-center w-full text-[#b8cd06] transition-all duration-200 ease-in-out transform -translate-x-full group-hover:translate-x-0 opacity-0 group-hover:opacity-100">
