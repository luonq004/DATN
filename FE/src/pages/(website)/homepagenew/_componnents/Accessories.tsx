  ...
  return (
    <div className="h-auto mx-auto px-5 sm:px-8 lg:px-28 mt-24 md:mt-20">
      ...
      <div className="text-center mb-10">
        ...
        <h2 className="text-3xl px-10 sm:text-4xl font-bold">
          CHỌN MỘT PHONG CÁCH
        </h2>
      ...
      {/* Lưới sản phẩm */}
      <div className="grid grid-cols-1 sm:grid-cols-3 md:mt-20 lg:grid-cols-5 gap-2">
        {products.map((product) => (
          <div
            key={product.id}
            className="group text-center relative border border-gray-200 rounded-lg overflow-hidden"
          >
            {product.badge && (
              <span
                className={`absolute top-3 left-3 px-2 py-1 text-xs rounded-full z-20 ${
            ...
            <p className="text-[#b8cd06] text-xs uppercase tracking-widest relative transition-all duration-300 top-0 group-hover:top-[-15px] z-20" >
              PHIÊN BẢN HIỆN ĐẠI
            </p>
            <h3 className="text-sm font-bold text-gray-800 group-hover:text-[#b8cd06] py-2 relative transition-all duration-300 top-0 group-hover:top-[-15px] z-20">
              {product.name}
            </h3>
            ...
            <div className="absolute inset-0 mb-16  space-y-2 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white bg-opacity-90">
              <button className="group relative px-16 py-5 text-xs bg-black text-white rounded-full font-semibold overflow-hidden transform -translate-y-full group-hover:translate-y-0 transition-transform duration-300">
              ...
              <button className="group relative px-16 py-5 text-xs bg-[#b8cd06] text-white rounded-full font-semibold overflow-hidden transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
      ...
      <div className="flex justify-center mt-8 md:mt-14">
        <button className="group relative px-40 md:px-24 py-6 text-sm bg-[#b8cd06] text-white rounded-full overflow-hidden">
          <span className="absolute text-xs top-4 md:left-7 left-24 transition-all duration-200 ease-in-out transform group-hover:translate-x-full group-hover:opacity-0">
            XEM TẤT CẢ PHỤ KIỆN
          </span>
          <span className="absolute inset-y-0 left-0 flex items-center justify-center w-full text-white transition-all duration-200 ease-in-out transform -translate-x-full group-hover:translate-x-0 opacity-0 group-hover:opacity-100">
            <svg
